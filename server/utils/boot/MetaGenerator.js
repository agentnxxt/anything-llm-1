  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "UnlimitedLLM | Your personal LLM trained on anything",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://vps.agnnxt.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://vps.agnnxt.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            content:
              customTitle ??
              "UnlimitedLLM | Your personal LLM trained on anything",
          };
        }
        // Override meta title
