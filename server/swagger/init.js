...
const doc = {
  info: {
    version: "1.0.0",
    title: "UnlimitedLLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your UnlimitedLLM instance. UI supplied by Swagger.io.",
  },
