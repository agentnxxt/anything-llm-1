...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "UnlimitedLLM může pracovat s mnoha poskytovateli LLM. Toto bude služba, která bude zpracovávat chatování.",
    },
    userSetup: {
    ...
    survey: {
      title: "Vítejte v UnlimitedLLM",
      description:
        "Pomozte nám vybudovat UnlimitedLLM pro vaše potřeby. Volitelné.",
      email: "Jaký je váš e-mail?",
      useCase: "K čemu budete UnlimitedLLM používat?",
      useCaseWork: "Pro práci",
      useCasePersonal: "Pro osobní použití",
      useCaseOther: "Jiné",
      comment: "Jak jste se o UnlimitedLLM dozvěděli?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        "beta-badge": "Beta",
        description:
          "Umožněte použití libovolného počtu nástrojů a snížit využití tokenů až o 80 % pro každou dotaz — UnlimitedLLM automaticky vybírá vhodné dovednosti pro každou žádost.",
        "max-tools": {
          title: "Nástroje Max",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Nastavte své předvolby rozhraní pro UnlimitedLLM.",
    },
    branding: {
      title: "Značení a bílé označení",
      description:
        "Bílé označení instance UnlimitedLLM pomocí vlastního značení.",
    },
    chat: {
      title: "Chat",
      description: "Nastavte své předvolby chatu pro UnlimitedLLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Vyberte preferovaný jazyk pro vykreslení rozhraní UnlimitedLLM - pokud jsou k dispozici překlady.",
      },
      logo: {
        title: "Logo značky",
        description:
  ...
  api: {
    title: "API klíče",
    description:
      "API klíče umožňují držiteli programově přistupovat a spravovat tuto instanci UnlimitedLLM.",
  ...
  llm: {
    title: "Preferovaný LLM",
    description:
      "Toto jsou přihlašovací údaje a nastavení pro vašeho preferovaného poskytovatele chatu a embeddingu LLM. Je důležité, aby tyto klíče byly aktuální a správné, jinak UnlimitedLLM nebude fungovat správně.",
  ...
  transcription: {
    ...
    "warn-start":
      "Použití místního modelu whisper na strojích s omezenou RAM nebo CPU může zastavit UnlimitedLLM při zpracování mediálních souborů.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding je proces převodu textu na vektory. Tyto přihlašovací údaje jsou nutné k převodu vašich souborů a výzev do formátu, který UnlimitedLLM může použít ke zpracování.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Toto jsou přihlašovací údaje a nastavení, jak bude vaše instance UnlimitedLLM fungovat. Je důležité, aby tyto klíče byly aktuální a správné.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chraňte svou instanci UnlimitedLLM heslem. Pokud zapomenete, neexistuje způsob obnovení, proto se ujistěte, že heslo uložíte.",
  ...
  privacy: {
    ...
    description:
      "Toto je vaše konfigurace, jak připojené třetí strany a UnlimitedLLM zpracovávají vaše data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Tyto soubory budou nahrány na procesor dokumentů běžící na této instanci UnlimitedLLM. Tyto soubory nejsou odesílány nebo sdíleny s třetí stranou.",
    },
    pinning: {
      what_pinning: "Co je připínání dokumentů?",
      pin_explained_block1:
        "Když <b>připnete</b> dokument v UnlimitedLLM, vložíme celý obsah dokumentu do vašeho okna výzvy, aby ho LLM plně pochopil.",
      ...
      pin_explained_block3:
        "Pokud nedostáváte odpovědi, které si přejete od UnlimitedLLM ve výchozím nastavení, pak připínání je skvělý způsob získání kvalitnějších odpovědí jedním kliknutím.",
      accept: "OK, rozumím",
    },
    watching: {
      what_watching: "Co dělá sledování dokumentu?",
      watch_explained_block1:
        "Když <b>sledujete</b> dokument v UnlimitedLLM, <i>automaticky</i> synchronizujeme obsah dokumentu z jeho původního zdroje v pravidelných intervalech. Tím se automaticky aktualizuje obsah v každém pracovním prostoru, kde je tento soubor spravován.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Musíte se ověřit pomocí komunitního centra UnlimitedLLM před publikováním položek.",
